...
def visualize_pet_data(pet_volume, pet_datasets, rd_dataset=None, rs_dataset=None, structures=None, ct_volume=None):
    ...
    plt.tight_layout()
    hotspot_path = os.path.join("extra_data/PVH", "PET_Hotspot_Analysis.png")
    ...
    plt.tight_layout()
    profile_path = os.path.join("extra_data/PVH", "PET_Activity_Profile.png")
